<template>
  <div ref="editor"  class="ql-editor q7-quill" :class="{'is-disabled':'disabled'}" style="width:100%;min-height: 300px;"></div>
</template>
...
export default {
  ...
  props: {
    ...
    // 上传参数，会临时覆盖全局上传配置参数[q7-uploader](/guide/extends/uploader.html)
    uploader: {
      type: Object,
      default: () => {
        return {}
  ...
  methods: {
    ...
    getUploader () {
      ...
      return q7Uploader.getUploader(type)
    },
    beforeUpload (file) {
