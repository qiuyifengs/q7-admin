...
import Q7Checkbox from '../checkbox/component.js'
import Q7SlideTransition from '../slide-transition/component.js'
...
export default {
  ...
  computed: {
    classes () {
      return `q7-tree` +
        (this.noConnectors === true ? ` q7-tree--no-connectors` : '') +
    ...
    computedIcon () {
      return this.icon || this.$q7.iconSet.tree.icon
    },
  ...
  methods: {
    ...
    __getSlotScope (node, meta, key) {
      const scope = { tree: this, node, key, color: this.color }
    ...
    __getNodeMedia (h, node) {
      if (node.icon !== void 0) {
        return h(Q7Icon, {
          staticClass: `q7-tree__icon mr-4`,
      ...
      if (src) {
        return h('img', {
          staticClass: `q7-tree__${node.img ? 'img' : 'avatar'} mr-4`,
          attrs: { src }
        })
      }
    },
    ...
    __getNode (h, node) {
      ...
      if (body !== void 0) {
        body = h('div', { staticClass: 'q7-tree__node-body relative' }, [
      ...
      return h('div', {
        key,
        staticClass: 'q7-tree__node relative',
        class: { 'q7-tree__node--parent': isParent, 'q7-tree__node--child': !isParent }
      }, [
        h('div', {
          staticClass: 'q7-tree__node-header relative row flex-no-wrap items-center',
          class: {
            'q7-tree__node--link q7-hoverable q7-focusable': meta.link,
            'q7-tree__node--selected': meta.selected,
            'q7-tree__node--disabled': meta.disabled
          },
          ...
          h('div', { staticClass: 'q7-focus-helper', attrs: { tabindex: -1 }, ref: `blurTarget_${meta.key}` }),
          ...
          meta.hasTicking === true && meta.noTick !== true
            ...
            meta.lazy === 'loading'
            ? h(Q7Spinner, {
              staticClass: 'q7-tree__spinner mr-4',
              props: { color: this.computedControlColor }
            })
            : (
              isParent === true
                ? h(Q7Icon, {
                  staticClass: 'q7-tree__arrow',
                  class: { 'q7-tree__arrow--rotate': meta.expanded },
          ...
          h('div', {
            'staticClass': 'q7-tree__node-header-content col row no-wrap items-center',
        ...
        isParent === true
          ? h(Q7SlideTransition, {
            ...
            h('div', {
              staticClass: 'q7-tree__node-collapsible',
              ...
              h('div', {
                staticClass: 'q7-tree__children',
                class: { 'q7-tree__node--disabled': meta.disabled }
              }, children)
            ])
          ])
          : body
